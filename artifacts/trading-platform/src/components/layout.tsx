...
import { Activity, BarChart2, Briefcase, LayoutDashboard, Settings as SettingsIcon, Link as LinkIcon, Menu, X, Calculator, Bot, Blocks } from "lucide-react";
...
const navItems = [
  ...
  { href: "/bot-builder", label: "Bot Builder", icon: Blocks },
