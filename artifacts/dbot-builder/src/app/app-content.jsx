        ...
        <React.Fragment>
            {PreviewBranding && (
                <Suspense fallback={null}>
                    <PreviewBranding uiReady />
                </Suspense>
            )}
            <AuthLoadingWrapper>
                <ThemeProvider theme={is_dark_mode_on ? 'dark' : 'light'}>
                    {/* Keep the workspace mounted while symbols/auth finish in the
                        background. The run action has an explicit account-ready
                        guard, so this removes the six-second blank-screen gate
                        without allowing an unauthenticated purchase. */}
                    <BlocklyLoading />
