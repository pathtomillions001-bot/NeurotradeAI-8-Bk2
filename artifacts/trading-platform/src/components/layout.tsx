...
import { Activity, BarChart2, Briefcase, LayoutDashboard, Settings as SettingsIcon, Link as LinkIcon, Menu, X, Calculator, Bot, Puzzle } from "lucide-react";
...
const navItems = [
  ...
  // Bot Studio — the embedded Deriv DBot builder (build/run a bot on the same
  // connected account; see pages/bot-studio.tsx).
  { href: "/bot-studio", label: "Bot Studio", icon: Puzzle },
